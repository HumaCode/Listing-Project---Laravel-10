...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li
                class="dropdown {{ setSidebarActive(['admin.category.*', 'admin.location.*', 'admin.amenity.*', 'admin.listing.*', 'admin.listing-image-galery.*', 'admin.listing-video-galery.*', 'admin.listing-schedule.*']) }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                ...
                <ul class="dropdown-menu">
                    ...
                    <li
                        class="{{ setSidebarActive(['admin.listing.*', 'admin.listing-image-galery.*', 'admin.listing-video-galery.*', 'admin.listing-schedule.*']) }}">
