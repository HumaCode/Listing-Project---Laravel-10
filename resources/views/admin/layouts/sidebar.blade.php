...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li
                class="dropdown {{ setSidebarActive(['admin.category.index', 'admin.category.create', 'admin.category.edit', 'admin.location.index', 'admin.location.create', 'admin.location.edit', 'admin.amenity.index', 'admin.amenity.create', 'admin.amenity.edit']) }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
