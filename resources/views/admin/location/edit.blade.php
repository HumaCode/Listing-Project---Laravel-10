                                        ...
                                        <div
                                            ...
                                            <div class="selectric-hide-select">
                                                <select class="form-control selectric" tabindex="-1" name="show_at_home">
                                                    <option value="1" @selected($location->show_at_home === 1)>Yes</option>
                                                    <option value="0" @selected($location->show_at_home === 0)>No</option>
                                                </select>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="selectric-hide-select">
                                                <select class="form-control selectric" tabindex="-1" name="status">
                                                    <option value="1"@selected($location->status === 1)>Active</option>
                                                    <option value="0"@selected($location->status === 0)>Inactive</option>
                                                </select>
                                            </div>
